...
AMySecondActor::AMySecondActor()
{
	...
	MyBadMesh->SetWorldScale3D(FVector(0.2f, 0.2f, 0.2f));

	auto MyBadMeshAsset = ConstructorHelpers::FObjectFinder<UStaticMesh>(TEXT("StaticMesh'/Game/Mesh/RedFlower/red_flower.red_flower'"));
